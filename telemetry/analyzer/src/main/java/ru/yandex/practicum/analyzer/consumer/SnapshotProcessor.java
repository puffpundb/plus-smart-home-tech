...
//
//				for (ConsumerRecords<Void, SensorsSnapshotAvro> recordBatch : records) {
//					for (org.apache.kafka.clients.consumer.ConsumerRecord<Void, SensorsSnapshotAvro> record : recordBatch) {
